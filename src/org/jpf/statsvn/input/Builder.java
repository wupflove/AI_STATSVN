...
/**
 * <p>
 * Helps building the {@link org.jpf.statsvn.input.SvnLogBuilder} from a SVN log. The <tt>Builder</tt> is fed by some SVN history data source, for example a SVN
	...
	* @param tagsPattern
    ...
    public Repository createRepository() {
        ...
        while (it.hasNext()) {
            ...
            result.addFile(file);
            logger.info("adding " + file.getFilenameWithPath() + " (" + file.getRevisions().size() + " revisions)");
        }
        ...
        logger.info("SYMBOLIC NAMES - " + symbolicNames);
