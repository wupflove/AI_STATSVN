...
import org.jpf.statsvn.util.ISvnDiffProcessor;
import org.jpf.statsvn.util.ISvnInfoProcessor;
import org.jpf.statsvn.util.ISvnProcessor;
import org.jpf.statsvn.util.ISvnPropgetProcessor;
import org.jpf.statsvn.util.ISvnVersionProcessor;
	...
	*/
	...
	public int getLinesOfCode(final String filename) throws NoLineCountException {
		...
		try {
			...
			logger.info("line count for '" + absoluteName + "': " + linecount);
			freader.close();
			return linecount;
