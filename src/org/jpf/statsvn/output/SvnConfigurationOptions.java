...
import org.jpf.statsvn.util.SvnCommandLineProcessor;
import org.jpf.statsvn.util.svnkit.SvnKitProcessor;
 ...
 * {@link org.jpf.statsvn.Main#main} method. Interested classes can read all
	...
	public static ISvnProcessor getProcessor()
	{
	    if (processor==null) {
	        if (isUsingSVNKit()) {
	            ...
	            {
	                logger.error("Unable to find svnkit.jar and/or jna.jar in the same folder as statsvn.jar. Please copy these files and try again.");
	                throw ex;
	            }
	        }
	        else
